\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \draw[->, >=stealth] (-0.5, 1) to [out=180, in=90] node [midway, left] {\shortstack{Compute\\keys}} (-1.5, -1);
...
%        \node[draw=none, rectangle, minimum width=1cm, minimum height=1cm, text centered] (kh) at (-1.5, 1.5) {$K$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=kh] (k1) {1};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=k1] (k2) {5};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=k2] (k3) {5};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=k3] (k4) {6};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=k4] (k5) {3};
%        \node[draw=none, rectangle, minimum width=1cm, minimum height=1cm, text centered, below of=kh] (ph) {$P$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=ph] (p1) {1};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=p1] (p2) {2};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=p2] (p3) {3};
...
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=p4] (p5) {5};
        ...
        \draw[->, >=stealth] (-2, -2.5) to [out=180, in=180] node [midway, left] {Sort} (-2, -4.5);
...
%
%    \begin{tikzpicture}
%        \node[draw=none, rectangle, minimum width=1cm, minimum height=1cm, text centered] (lh) at (-1.5, 1.5) {$K$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=lh] (l1) {1};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=l1] (l2) {3};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=l2] (l3) {5};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=l3] (l4) {5};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=l4] (l5) {6};
        ...
        \draw[->, >=stealth] (qh.west) to [out=180, in=180] node[midway, left] {\shortstack[r]{Compute\\values}} ($(vh.west) + (0, 2pt)$);
        ...
        \draw[->, >=stealth] ($(vh.west)+(0, -2pt)$) to [out=180, in=180] node [midway, left] {Reduce} (mh.west); 
...
%
%    \begin{tikzpicture}
%        \node[draw=none, rectangle, minimum width=1cm, minimum height=1cm, text centered] (wh) at (-1.5, 1.5) {$V$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=wh] (w1) {$v_1$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=w1] (w2) {$v_5$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=w2] (w3) {$\scriptstyle v_2+v_3$};
%        \node[draw, rectangle, minimum width=1cm, minimum height=1cm, right of=w3] (w4) {$v_4$};
        ...
        \draw[->, >=stealth] (wh.west) to [out=180, in=180] node [midway, left, yshift=2pt] {Add} (fh.west);
        ...
        \draw[->, >=stealth] (6.75, -11) to [out=45, in=0] node [midway, left, xshift=-2pt] {\shortstack[r]{Repeat for\\each shift}} (4.25, -6);
    \end{tikzpicture}
