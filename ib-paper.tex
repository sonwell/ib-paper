...
architectures. We test these algorithms on arbitrarily scattered points and elastic 
structures. The tests exhibit near-ideal scaling for the algorithms on both a multicore
CPU and GPU.
